...
// Verified April 2026. Removed delisted: CRH.L (→NYSE), FERG.L (→NYSE), BHP.L (→ASX), SMDS.L (acq IP).
// SMT.L = Scottish Mortgage Investment Trust (NOT Smiths Group — that is SMIN.L).
export const UK_STOCKS = [
  'SHEL.L', 'AZN.L', 'HSBA.L', 'ULVR.L', 'BP.L',   'GSK.L',  'RIO.L',  'REL.L',  'DGE.L',  'BATS.L',
  'LSEG.L', 'NG.L',  'AAL.L',  'GLEN.L', 'VOD.L',  'PRU.L',  'LLOY.L', 'BARC.L', 'RKT.L',  'IMB.L',
  'SSE.L',  'AHT.L', 'BA.L',   'CPG.L',  'EXPN.L', 'STAN.L', 'ABF.L',  'ANTO.L', 'IAG.L',  'IHG.L',
  'KGF.L',  'LAND.L','LGEN.L', 'MNG.L',  'NWG.L',  'PSON.L', 'RR.L',   'SBRY.L', 'SGE.L',  'SMT.L',
  'SN.L',   'SPX.L', 'SVT.L',  'TSCO.L', 'WPP.L',  'WTB.L',  'SMIN.L', 'MNDI.L', 'CCH.L',  'CNA.L',
  'FRES.L', 'ENT.L'
]

// FTSE 250 — top 50 most liquid by market cap (mid-cap swing candidates)
// Verified April 2026. Removed delisted: DARK.L (acq Thoma Bravo), AGK.L (private),
// FDM.L (private), CINE.L (restructured). Moved SMIN.L, MNDI.L to FTSE 100 (correct index).
export const UK_STOCKS_250 = [
  'AUTO.L', 'WEIR.L', 'HIK.L',  'HWDN.L', 'IGG.L',
  'PHNX.L', 'BDEV.L', 'TW.L',   'RSW.L',  'HLMA.L',
  'CRDA.L', 'OSB.L',  'DPLM.L', 'IMI.L',  'RTO.L',
  'BNZL.L', 'JET2.L', 'TPK.L',  'DOCS.L', 'INF.L',
  'TMPL.L', 'MGAM.L', 'BOWL.L', 'BWNG.L', 'FOUR.L',
  'SDR.L',  'JDW.L',  'CARD.L', 'ITV.L',  'HSX.L',
  'BOY.L',  'GNS.L',  'BME.L',  'DRVL.L', 'GAW.L',
  'INCH.L', 'PAGE.L', 'VTY.L',  'BRBY.L', 'EZJ.L',
  'WHC.L',  'BYIT.L', 'SHI.L',  'HBR.L',  'HAS.L',
  'PETS.L', 'HOC.L',  'DNLM.L'
]
